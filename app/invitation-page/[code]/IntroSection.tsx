...
export default function IntroSection({
  ...
  return (
    <div style={{
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: textSide, justifyContent: "center", padding: "32px 28px", textAlign }}>
        {showGreeting && (
          <>
            <p style={{ marginBottom: 6 }}>
              <span style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 500, fontSize: 15, color: "#5F5F5F" }}>{tr.dearGuest} </span>
              <span style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 700, fontSize: 15, color: "#5F5F5F" }}>{guestGreeting},</span>
            </p>
            <p style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 500, fontSize: 15, color: "#5F5F5F", marginBottom: 20, maxWidth: 260 }}>
              {tr.invitedTo}
            </p>
          </>
        )}
        ...
        <p style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 500, fontSize: 15, color: "#5F5F5F", marginBottom: 4 }}>
          {parentLabel}
        </p>
        <p style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 700, fontSize: 15, color: "#5F5F5F", maxWidth: 260 }}>
          {parentNames}
        </p>
      </div>
      ...
      <div style={{ flex: 1, display: "flex", alignItems: "flex-start", justifyContent: photoSide }}>
        {photoUrl && (
          <div style={{
            ...
            marginBottom: 28, marginTop: 28, position: "relative"
          }}>
            {stampUrl && align === "left" && (
